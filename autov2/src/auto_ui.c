...
int com_load_automate_from_file (), com_help (), com_cd (), com_quit ();
int com_automate_DOT (); int com_automate_isword ();
     ...
     char **argv;
{
  ...
  if (argc>1) paut=loadAutomateFromFile(argv[1]);
...
int
com_load_automate_from_file (arg)
     char *arg;
{
